...
public class SecureSessionTest extends DevApiBaseTestCase {
    final String trustStoreUrl = "file:src/test/Ext.ConfigurationReader/ssl-test-certs/ca-truststore";
    final String trustStorePath = "src/test/Ext.ConfigurationReader/ssl-test-certs/ca-truststore";
    final String trustStorePassword = "password";

    final String clientKeyStoreUrl = "file:src/test/Ext.ConfigurationReader/ssl-test-certs/client-keystore";
    final String clientKeyStorePath = "src/test/Ext.ConfigurationReader/ssl-test-certs/client-keystore";
