...
public class ConnectionTest extends BaseTestCase {
     ...
     * 
     * This test requires the CA truststore and the client keystore available in src/test/Ext.ConfigurationReader/ssl-test-certs.
     * The server needs to be configured with the CA and server certificates from src/test/Ext.ConfigurationReader/ssl-test-certs.
     */
    public void testUserRequireSSL() throws Exception {
         ...
         */
        props.setProperty(PropertyKey.clientCertificateKeyStoreUrl.getKeyName(), "file:src/test/Ext.ConfigurationReader/ssl-test-certs/client-keystore");
