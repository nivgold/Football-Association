...
CREATE TABLE member(
    ...
    email varchar (255),
    systemManager boolean NOT NULL,
    -- FOREIGN KEYS
...
INSERT INTO `member` (`username`,`passwordHash`,`name`, `email`, `addressID`, systemManager)
    VALUES ('teamOwner_Koren','833df42ad4b881262b26fe02df0f6cef26b27266','Koren Ishlach', 'korenish@post.bgu.ac.il', 1, 0);
...
INSERT INTO `member` (`username`,`passwordHash`,`name`, `email`, `addressID`, systemManager)
    VALUES ('teamOwner_Niv','f213c58a5a9f87db49e3ab9ddfee3332075d4ced','Niv GoldShlager', 'nivgold@post.bgu.ac.il', 2, 0);
...
INSERT INTO `member` (`username`,`passwordHash`,`name`, `email`, `addressID`, systemManager)
    VALUES ('teamOwner_Tal','a96c9ea7833b5a8698f9bfc042fbfab1ea90040a','Tal Frimerman', 'talfrim@post.bgu.ac.il', 4, 0);
...
INSERT INTO `member` (`username`,`passwordHash`,`name`, `email`, `addressID`, systemManager)
    VALUES ('assocAgent yarin','c424197946a55fcc400a20811aeaeeda3d72d71d','Yarin Nahum', 'yarina@post.bgu.ac.il', 6, 0);
...
INSERT INTO `member` (`username`,`passwordHash`,`name`, `email`, `addressID`, systemManager)
    VALUES ('main Referee asaf','1608f3ee993f91f37818451c218b393896f214dd','asaf zosman', 'asafzos@post.bgu.ac.il', 7, 0);
...
INSERT INTO game (date, host_teamID, guest_teamID, main_refereeID, seasonYear, leagueID, fieldID)
    VALUES ('2020-05-29 20:00:00', 1, 2, 1, 2020, 1, 1);

INSERT INTO `member` (`username`,`passwordHash`,`name`, `email`, `addressID`, systemManager)
    VALUES ('side Referee asaf1','63ee39facef3e951eddbfad442b8624a811563e0','asaf1 zosman', 'asafzos1@post.bgu.ac.il', 7, 0);

INSERT INTO `member` (`username`,`passwordHash`,`name`, `email`, `addressID`, systemManager)
    VALUES ('side Referee asaf2','5f18c71e0494f65f47f52d0984644110b85a7af2','asaf2 zosman', 'asafzos2@post.bgu.ac.il', 7, 0);
